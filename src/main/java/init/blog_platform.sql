...
-- Sample Data
INSERT INTO posts (title, content, author_id, tag_id)
VALUES
('Welcome to My Blog', 'This is the first post!', 1, 2),
('Learning Spring Boot', 'Spring Boot makes development easy!', 1, 1);
